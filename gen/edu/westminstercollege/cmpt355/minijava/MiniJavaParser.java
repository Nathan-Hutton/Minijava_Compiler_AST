		...
		try {
			...
			case 8:
				...
				if ( !(_la==T__8 || _la==T__9) ) {
					...
					consume();
				        ...
				        ((ExpressionContext)_localctx).n =  new PostIncrement(_localctx, new VariableAccess(_localctx, (((ExpressionContext)_localctx).NAME!=null?((ExpressionContext)_localctx).NAME.getText():null)), (((ExpressionContext)_localctx).op!=null?((ExpressionContext)_localctx).op.getText():null));
			...
			case 10:
				...
				((ExpressionContext)_localctx).expression = expression(4);
				        ...
				        ((ExpressionContext)_localctx).n =  new Cast(_localctx, new TypeNode(_localctx, (((ExpressionContext)_localctx).type!=null?_input.getText(((ExpressionContext)_localctx).type.start,((ExpressionContext)_localctx).type.stop):null)), ((ExpressionContext)_localctx).expression.n);
