...
public class MiniJavaParser extends Parser {
	...
	public static final int
		RULE_goal = 0, RULE_classNode = 1, RULE_block = 2, RULE_statement = 3, 
		RULE_imports = 4, RULE_fieldDefinition = 5, RULE_methodDefinition = 6, 
		RULE_mainMethod = 7, RULE_variableDeclaration = 8, RULE_variableDeclarationItem = 9, 
		RULE_parameter = 10, RULE_expression = 11, RULE_type = 12;
	private static String[] makeRuleNames() {
		return new String[] {
			"goal", "classNode", "block", "statement", "imports", "fieldDefinition", 
			"methodDefinition", "mainMethod", "variableDeclaration", "variableDeclarationItem", 
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 8385454614L) != 0) {
				{
				{
				setState(54);
	...
	public final MainMethodContext mainMethod() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_mainMethod);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(152);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 8322540032L) != 0) {
					{
					setState(188);
